      ...
      <section class="feature_area p_120" id="visi">
        <div class="container">
          <div class="main_title">
            <h2>Visi Misi</h2>
            <p>
              Dedikasi dan komitmen untuk membangun masyarakat DKI Jakarta,
              khususnya Warga Dapil 8 kecamatan Jagakarsa, Pasar Minggu, Tebet,
              Pancoran, dan Mampang Prapatan.
            </p>
          </div>
          <div class="feature_inner row">
            <div class="col-lg-6 col-md-8">
              <div class="feature_item">
                ...
                <p class="text-center">
                  Meningkatkan kesejahteraan dan keadilan kebijakan publik bagi
                  seluruh masyarakat.
                </p>
                <br></br>
                <br></br>
